# Getting help with SetListR

Thanks for using SetListR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/SetListR/issues) to make sure the 
